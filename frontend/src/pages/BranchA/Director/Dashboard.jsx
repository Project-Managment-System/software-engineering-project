...
const THEME_STORAGE_KEY = 'branch-a-director-dashboard-theme';
const ACCENT_STORAGE_KEY = 'branch-a-director-dashboard-accentTheme';

const BranchADirectorDashboard = () => {
        ...
        <aside className={`sidebar ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
          <div className="profile-box">
            ...
            <div className="profile-info">
              <h3>Director</h3>
              <p className="reg-number">Branch A</p>
                ...
                <motion.div className="recent-jobs-card" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.3 }}>
                  ...
                  <div className="table-scroll-wrapper">
                    <table className="project-table">
                      <thead>
                        <tr>
                          <th>Serial No</th><th>Job No</th><th>Activity</th><th>Ministry</th><th>Division</th>
...
export default BranchADirectorDashboard;
