...
const THEME_STORAGE_KEY = 'branch-a-engineer-dashboard-theme';
const ACCENT_STORAGE_KEY = 'branch-a-engineer-dashboard-accentTheme';

const BranchAEngineerDashboard = () => {
...
export default BranchAEngineerDashboard;
