...
const THEME_STORAGE_KEY = 'branch-d-director-dashboard-theme';
const ACCENT_STORAGE_KEY = 'branch-d-director-dashboard-accentTheme';

const BranchDDirectorDashboard = () => {
...
export default BranchDDirectorDashboard;
